...
def metrics_collector():
    ...
    return MetricsCollector(collection_interval=0.1, max_history=10, enable_system_metrics=True, enable_async_metrics=True)
...
class TestSystemMonitor:
    ...
    async def test_collect_system_metrics(self, mock_net, mock_disk_io, mock_disk, mock_memory, mock_cpu, system_monitor):
        ...
        mock_disk_usage.return_value = MagicMock(total=1024 * 1024 * 1024 * 1024, used=512 * 1024 * 1024 * 1024, free=512 * 1024 * 1024 * 1024)
        mock_disk_io.return_value = MagicMock(read_bytes=1024 * 1024, write_bytes=2 * 1024 * 1024, read_count=100, write_count=200)
        mock_net.return_value = MagicMock(bytes_sent=1024 * 1024 * 10, bytes_recv=1024 * 1024 * 20, packets_sent=1000, packets_recv=2000, errin=0, errout=0)
    ...
    def test_average_metrics_calculation(self, system_monitor):
        ...
        assert avg_metrics.cpu_percent == 30.0
        assert avg_metrics.memory_percent == 40.0
