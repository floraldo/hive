...
def validate_qr_generator(test_case):
    ...
    try:
        ...
        install_result = subprocess.run([sys.executable, "-m", "pip", "install", "-r", "requirements.txt"], check=False, cwd=app_dir, capture_output=True, text=True, timeout=120)
        ...
        try:
            ...
            test_result = subprocess.run([sys.executable, "test_qr_generator.py"], check=False, cwd=app_dir, capture_output=True, text=True, timeout=60)
            server_process.terminate()
