...
class Battery(Component):
    def __init__(self, name, P_max, E_max, E_init, eta, n,  economic=None, environmental=None):
        ...
        self.flows['sink']['P_cha'] = {'type': 'electricity',
                                       'value': cp.Variable(n, nonneg=True, name=f'{name}_P_cha')}
        self.flows['source']['P_dis'] = {'type': 'electricity',
                                         'value': cp.Variable(n, nonneg=True, name=f'{name}_P_dis')}
        self.constraints += [
