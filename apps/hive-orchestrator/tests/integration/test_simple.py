...
def run_all_tests():
    ...
    logger.info('=' * 50)
    tests = [('Module Imports', test_module_imports), ('CLI Module', test_cli_module_basic), ('Clean Hive Module', test_clean_hive_module), ('Dashboard Module', test_dashboard_module), ('Error Handling', test_error_handling), ('Configuration Handling', test_configuration_handling)]
    results = []
