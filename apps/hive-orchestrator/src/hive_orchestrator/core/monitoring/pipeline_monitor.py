...
class PipelineMonitor:
    ...
    def check_health(self, metrics: PipelineMetrics) -> Tuple[HealthStatus, List[PipelineAlert]]:
        ...
        if metrics.stuck_tasks_count > 0:
            ...
            alerts.append(PipelineAlert(
                ...
                details={"stuck_count": metrics.stuck_tasks_count, "threshold_minutes": self.alert_thresholds["stuck_task_minutes"]},
        ...
        if metrics.error_rate_percentage > self.alert_thresholds["error_rate_percentage"]:
            ...
            alerts.append(PipelineAlert(
                ...
                details={"error_rate": metrics.error_rate_percentage, "threshold": self.alert_thresholds["error_rate_percentage"]},
                timestamp=datetime.now(timezone.utc).isoformat(),
        ...
        if metrics.pipeline_throughput_per_hour < self.alert_thresholds["low_throughput_per_hour"]:
            alerts.append(PipelineAlert(
                ...
                details={"throughput": metrics.pipeline_throughput_per_hour, "threshold": self.alert_thresholds["low_throughput_per_hour"]},
                timestamp=datetime.now(timezone.utc).isoformat(),
    ...
    def _generate_recommendations(self, metrics: PipelineMetrics, health: HealthStatus, alerts: List[PipelineAlert]) -> List[str]:
