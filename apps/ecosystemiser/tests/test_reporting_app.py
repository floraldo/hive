...
def sample_results_data():
    ...
    return {
        ...
        "flows": {"grid_import": {"values": [10, 20, 30]}},
        "kpis": {"grid_self_sufficiency": 0.8, "renewable_fraction": 0.6},
        "solver_metrics": {"status": "optimal", "solve_time": 1.234},
    }
...
def sample_analysis_results():
    ...
    return {
        ...
        "summary": {
            ...
            "failed_analyses": 0,
            "key_metrics": {"grid_self_sufficiency": 0.8, "renewable_fraction": 0.6},
        },
        "analyses": {
            "technical_kpi": {
            ...
            "economic": {"lcoe": 0.12, "npv": 50000, "capex_total": 150000},
        },
    }
...
class TestFlaskApp:
    ...
    def test_app_creation_with_config(self):
        ...
        config = {"TESTING": True, "SECRET_KEY": "custom-key"}
    ...
    def test_upload_post_success(
        self, mock_analyser_class, client, sample_results_data, sample_analysis_results
    ):
        ...
        with tempfile.NamedTemporaryFile(mode="w", suffix=".json", delete=False) as f:
            ...
            with open(f.name, "rb") as upload_file:
                response = client.post(
                    "/upload", data={"results_file": (upload_file, "test.json")}
                )
    ...
    @patch("EcoSystemiser.reporting.app.AnalyserService")
    def test_upload_post_analysis_error(
        self, mock_analyser_class, client, sample_results_data
    ):
    ...
    def test_api_analyze_success(
        ...
        response = client.post(
            "/api/analyze", json=sample_results_data, content_type="application/json"
        )
    ...
    def test_api_plot_unknown_type(self, client):
        ...
        response = client.post(
            "/api/plot/unknown_plot", json={}, content_type="application/json"
        )
...
class TestPlotGeneration:
    ...
    def test_generate_plots_with_sensitivity(self):
        ...
        analysis_results = {
            "analyses": {
                "sensitivity": {"parameter_sensitivities": {}, "trade_off_analysis": {}}
            }
        }
    ...
    def test_generate_plots_with_raw_data(self, sample_results_data):
        ...
        plot_factory.create_optimization_convergence_plot.return_value = {
            "test": "convergence"
        }
    ...
    def test_error_handling_in_plot_generation(self):
        ...
        analysis_results = {"analyses": {"technical_kpi": {}}}
