...
def run_cli_command(args: list[str], description: str = "") -> bool:
    ...
    try:
        result = subprocess.run(
            cmd, capture_output=True, text=True, cwd=SRC_DIR, timeout=60
        )
    ...
    tests = [
        {
            ...
            "args": [
                ...
                "nasa_power",
                "--out",
                f"../{OUTPUT_DIR.name}/test1.parquet",
            ],
        },
        {
            ...
            "args": [
                ...
                "nasa_power",
                "--out",
                f"../{OUTPUT_DIR.name}/test2.parquet",
            ],
        },
        {
        ...
        },
        {
            ...
            "args": [
                ...
                "--stats",
                "--out",
                f"../{OUTPUT_DIR.name}/test4.parquet",
            ],
        },
    ]
