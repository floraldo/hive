        ...
        "all_results": [
            {
                ...
                "kpis": {"total_cost": 150000, "renewable_fraction": 0.6},
            },
            {
                "status": "optimal",
                "output_config": {
                ...
                "kpis": {"total_cost": 200000, "renewable_fraction": 0.8},
            },
            {
                "status": "feasible",
                "output_config": {
                ...
                "kpis": {"total_cost": 100000, "renewable_fraction": 0.4},
            },
        ]
    }
...
class TestTechnicalKPIAnalysis:
    ...
    def test_battery_kpis(self, sample_energy_results):
        ...
        total_discharge = sum(
            sample_energy_results["flows"]["battery_discharge"]["values"]
        )
...
class TestEconomicAnalysis:
    ...
    def test_lcoe_calculation(self, sample_energy_results):
        ...
        lcoe = strategy._calculate_lcoe(
            capex, opex_annual, energy_metrics, sample_energy_results
        )
...
class TestSensitivityAnalysis:
    ...
    def test_influential_parameters(self):
        ...
        assert influential[0]["parameter"] in [
            "param1",
            "param2",
    ...
    def test_optimal_configurations(self, sample_parametric_results):
        ...
        optimal = strategy._find_optimal_configurations(
            sample_parametric_results["all_results"]
        )
        ...
        assert (
            max_renewable_config["renewable_fraction"] == 0.8
        )  # Should be highest renewable

    def test_pareto_frontier(self, sample_parametric_results):
        """Test Pareto frontier analysis."""
        strategy = SensitivityAnalysis()

        trade_offs = strategy._analyze_trade_offs(
            sample_parametric_results["all_results"]
        )
    ...
    def test_robustness_metrics(self, sample_parametric_results):
        ...
        metrics = strategy._calculate_robustness_metrics(
            sample_parametric_results["all_results"]
        )
