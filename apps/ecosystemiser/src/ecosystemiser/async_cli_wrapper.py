...
from ecosystemiser.services.async_facade import get_async_facade
...
class AsyncCLIWrapperFactory:
    """Factory for managing AsyncCLIWrapper instances.

    Follows Golden Rule - no global state, proper dependency injection.
    """

    def __init__(self):
        self._instance: Optional[AsyncCLIWrapper] = None

    def get_wrapper(self) -> AsyncCLIWrapper:
        """Get or create an async CLI wrapper instance.
...
# This should be injected as a dependency in new code
_default_factory = AsyncCLIWrapperFactory()


def get_async_cli_wrapper() -> AsyncCLIWrapper:
    """Get or create the async CLI wrapper.

    Legacy function for backward compatibility.
    New code should use AsyncCLIWrapperFactory directly.
