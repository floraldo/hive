...
tags_metadata = [
    ...
    {"name": "Profile Loader", "description": "Climate and demand profile data loading with multiple adapters"},
    {"name": "Climate Data", "description": "Climate data endpoints with batch processing and streaming"},
    {"name": "Solver", "description": "Optimization solver for energy system analysis (planned)"},
    {"name": "Analyser", "description": "Post-processing analytics and visualization (planned)"},
    {"name": "Reporting", "description": "Automated report generation and export (planned)"},
