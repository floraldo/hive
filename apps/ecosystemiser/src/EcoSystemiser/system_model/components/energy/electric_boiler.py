...
class ElectricBoilerTechnicalParams(GenerationTechnicalParams):
    ...
    control_algorithm: dict[str, Any] | None = Field(None, description="Control algorithm parameters")

    # RESEARCH fidelity parameters
    detailed_thermal_model: dict[str, Any] | None = Field(None, description="Detailed thermal modeling parameters")
    emissions_model: dict[str, Any] | None = Field(None, description="Detailed emissions modeling")
