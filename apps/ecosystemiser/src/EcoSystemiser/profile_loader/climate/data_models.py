...
class ClimateRequest(BaseProfileRequest):
    ...
    resolution: ClimateResolution | None = Field(default="1H", description="Data temporal resolution")
...
class ClimateResponse(BaseProfileResponse):
    ...
    path_parquet: str | None = None  # Made optional for cases where caching is disabled
    shape: tuple[int, int]
    stats: dict[str, Any] | None = None  # Changed to Any to handle nested dicts
