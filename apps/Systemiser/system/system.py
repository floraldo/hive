...
class System:
    ...
    def initialize_component(self, component_name, technical_params_df, economic_params_df, environmental_params_df, profiles):
        ...
        economic_params_obj = EconomicParameters(**economic_params, )
        ...
        component = component_class(component_name, **technical_params, economic=economic_params_obj, environmental=environmental_params_obj, n=self.N)
    ...
    def connect(self, component1_name, component2_name, flow_type, bidirectional=False, print_connection=True):
        ...
        flow = {
            ...
            'value': cp.Variable(component1.N, nonneg=True, 
    ...
    def set_objective(self, objective):
        objective_functions = {
            ...
            "min_peak_power": lambda: cp.max(self.components['Grid'].flows['source']['P_draw']['value'] +
    ...
    def aggregate_component_results(self, components, result_type):
        if result_type not in ['technical_results', 'economical_results', 'environmental_results']:
            raise ValueError("Invalid result type. Choose 'technical_results', 'economical_results', or 'environmental_results'.")
        ...
        for constraint in self.problem.constraints:
            ...
            if constraint_str not in seen:
                ...
                constraints_info.append({
                    ...
                    'variables': [str(v) for v in constraint.variables()]
                })
