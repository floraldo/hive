...
class ProfileManager:
    ...
    def load_profiles(self, 
                     ...
                     legacy_override: bool = False) -> Dict[str, Dict[str, Any]]:
        """
    ...
    def _get_weather_data(self, latitude: float, longitude: float, 
                         date_range: Dict[str, Any], N: int) -> pd.DataFrame:
...
def load_profiles_with_source(N: int = 24, 
                             source: ProfileSource = ProfileSource.LEGACY,
                             weather_config: Optional[Dict[str, Any]] = None) -> Dict[str, Dict[str, Any]]:
    """
