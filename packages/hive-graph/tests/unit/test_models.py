...
class TestCodeFile:
    ...
    def test_validation_error(self) -> None:
        ...
        with pytest.raises(ValidationError):
            CodeFile(path="/test/file.py")  # Missing language
...
class TestModuleDefinition:
    ...
    def test_create_package(self) -> None:
        ...
        package = ModuleDefinition(
            name="hive_graph",
            file_path="/src/hive_graph/__init__.py",
            docstring="Knowledge graph package",
            is_package=True,
        )
...
class TestFunctionDefinition:
    ...
    def test_create_async_function(self) -> None:
        ...
        func = FunctionDefinition(
            ...
            qualified_name="module.my_async_function",
            file_path="/test/module.py",
            line_start=5,
            line_end=10,
            signature="async def my_async_function() -> None",
            is_async=True,
        )
    ...
    def test_create_method(self) -> None:
        ...
        func = FunctionDefinition(
            ...
            line_start=5,
            line_end=10,
            signature="def my_method(self, x: int) -> None",
            is_method=True,
        )
    ...
    def test_create_classmethod(self) -> None:
        ...
        func = FunctionDefinition(
            name="my_classmethod",
            qualified_name="MyClass.my_classmethod",
            file_path="/test/module.py",
            line_start=5,
            line_end=10,
            signature="def my_classmethod(cls) -> None",
            is_classmethod=True,
    ...
    def test_function_with_parameters(self) -> None:
        ...
        func = FunctionDefinition(
            ...
            line_start=5,
            line_end=10,
            signature="def my_function(x: int, y: str = 'default') -> bool",
            parameters=[
...
class TestEdge:
    ...
    def test_create_edge_with_metadata(self) -> None:
        ...
        edge = Edge(
            source="function:module.func_a",
            target="function:module.func_b",
            edge_type=EdgeType.CALLS,
            metadata={"line_number": 42, "count": 5},
        )
    ...
    def test_edge_hashable(self) -> None:
        ...
        # Same source, target, and type should hash equally
        assert hash(edge1) == hash(edge2)

        # Can be added to a set
        edge_set = {edge1, edge2}
        assert len(edge_set) == 1  # Only one unique edge
...
class TestCodeGraph:
    ...
    def test_complex_graph_scenario(self) -> None:
        ...
        cls = ClassDefinition(
            name="MyClass",
            qualified_name="test.module.MyClass",
            file_path="/test/module.py",
            line_start=10,
            line_end=30,
        ...
        func = FunctionDefinition(
            name="my_method",
            qualified_name="test.module.MyClass.my_method",
            file_path="/test/module.py",
            line_start=15,
            line_end=20,
        ...
        graph.add_edge(Edge(
            source=module.get_id(),
            target=file.get_id(),
            edge_type=EdgeType.DEFINED_IN,
        ))
        graph.add_edge(Edge(
            source=cls.get_id(),
            target=module.get_id(),
