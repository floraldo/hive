...
class TestPromptError:
    ...
    def test_prompt_error_with_template_name(self):
        ...
        error = PromptError(
            "Missing variables",
            template_name="summarization.txt",
        )
    ...
    def test_prompt_error_with_missing_variables(self):
        ...
        error = PromptError(
            ...
            template_name="analysis.txt",
            missing_variables=["input_text", "context"],
        )
...
class TestExceptionHierarchy:
    ...
    def test_all_errors_are_exceptions(self):
        ...
        errors = [
            ...
            VectorError("test"),
            PromptError("test"),
            CostLimitError("test", 10.0, 5.0),
            ModelUnavailableError("test", "model", "provider"),
        ]
        for error in errors:
            assert isinstance(error, Exception)
