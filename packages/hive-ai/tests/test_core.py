...
class TestInterfaces:
    ...
    def test_token_usage_property(self, prompt_tokens, completion_tokens):
        ...
        usage = TokenUsage(prompt_tokens=prompt_tokens, completion_tokens=completion_tokens, total_tokens=total_tokens, estimated_cost=total_tokens * 0.0001)
    ...
    def test_model_response_property(self, content, model, tokens, cost):
        ...
        response = ModelResponse(content=content, model=model, tokens_used=tokens, cost=cost, latency_ms=1000, metadata={})
...
class TestPerformanceProperties:
    ...
    def test_token_usage_calculation_performance(self, token_count):
        ...
        usage = TokenUsage(prompt_tokens=token_count // 2, completion_tokens=token_count // 2, total_tokens=token_count, estimated_cost=token_count * 1e-05)
        assert usage.total_tokens == token_count
        assert usage.estimated_cost == token_count * 1e-05
