...
class TestModelResponse:
    ...
    def test_model_response_creation(self):
        ...
        response = ModelResponse(content="Generated text response", model="claude-3-sonnet", tokens_used=150, cost=0.015, latency_ms=1250, metadata={"provider": "anthropic", "stop_reason": "end_turn"})
    ...
    def test_model_response_empty_metadata(self):
        ...
        response = ModelResponse(content="Test", model="test-model", tokens_used=10, cost=0.001, latency_ms=100, metadata={})
        assert response.metadata == {}

    @pytest.mark.core
    def test_model_response_field_access(self):
        """Test accessing ModelResponse fields."""
        response = ModelResponse(content="Response", model="gpt-4", tokens_used=200, cost=0.02, latency_ms=2000, metadata={"key": "value"})
...
class TestTokenUsage:
    ...
    def test_token_usage_creation(self):
        ...
        usage = TokenUsage(prompt_tokens=100, completion_tokens=50, total_tokens=150, estimated_cost=0.015)
    ...
    def test_token_usage_total_calculation(self):
        ...
        usage = TokenUsage(prompt_tokens=75, completion_tokens=25, total_tokens=100, estimated_cost=0.01)
    ...
    def test_interface_complete_implementation(self):
        ...
        class CompleteProvider(ModelProviderInterface):
            ...
            async def generate_async(self, prompt, model, **kwargs):
                return ModelResponse(content="response", model=model, tokens_used=10, cost=0.001, latency_ms=100, metadata={})
