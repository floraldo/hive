...
def test_weather_data_integration():
    ...
    try:
        ...
        from utils.weather_utils import create_component_profiles_from_weather, calculate_weather_statistics
        ...
        if stats:
            ...
            if "temperature" in stats:
                ...
                print(
                    f"   Temperature: mean={temp_stats['mean_annual_c']:.1f}°C, "
            ...
            if "solar" in stats:
                ...
                print(
                    f"   Solar: mean={solar_stats['mean_annual_wm2']:.1f} W/m², "
        ...
        component_configs = {
            "solar_pv_100kw": {"type": "solar_pv", "capacity_kw": 100, "efficiency": 0.20, "system_losses": 0.15},
        ...
        if profiles:
            ...
            for comp_name, profile in profiles.items():
                if profile is not None and not profile.empty:
                    print(
                        f"   {comp_name}: mean={profile.mean():.2f}, max={profile.max():.2f}, "
        ...
        cached_df = weather_manager.get_data(
            latitude=latitude, longitude=longitude, start_date="20220101", end_date="20220107", use_cache=True
        )
