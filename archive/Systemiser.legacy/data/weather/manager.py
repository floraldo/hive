...
class WeatherDataManager:
    ...
    def get_data(
        ...
        **kwargs,
        ...
        self.logger.info(
            f"Getting weather data: lat={latitude}, lon={longitude}, "
    ...
    def get_data_for_year(
        ...
        **kwargs,
        ...
        return self.get_data(
            latitude, longitude, start_date, end_date, provider=provider, processor=processor, **kwargs
        )
    ...
    def get_data_for_years(
        ...
        **kwargs,
        ...
        for year in range(start_year, end_year + 1):
            ...
            year_df = self.get_data_for_year(
                latitude, longitude, year, provider=provider, processor=processor, **kwargs
            )
        ...
        self.logger.info(
            f"Successfully combined data for {len(year_dataframes)} years. " f"Total shape: {combined_df.shape}"
        )

        return combined_df

    def _get_cache_filename(
        self, latitude: float, longitude: float, start_date: str, end_date: str, provider: str, processor: str
    ) -> str:
    ...
    def _load_from_cache(
        ...
        try:
            ...
            if os.path.exists(metadata_file):
                ...
                # Basic validation
                if (
                    metadata.get("latitude") != latitude
                    or metadata.get("longitude") != longitude
                    or metadata.get("provider") != provider
                    or metadata.get("processor") != processor
                ):
