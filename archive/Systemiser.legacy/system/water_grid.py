...
class WaterGrid(WaterComponent):
    def __init__(self, name, W_max, n, economic=None, environmental=None):
        ...
        self.flows["sink"]["W_feed"] = {"type": "water", "value": cp.Variable(n, nonneg=True, name=f"{name}_W_feed")}
        self.flows["source"]["W_draw"] = {"type": "water", "value": cp.Variable(n, nonneg=True, name=f"{name}_W_draw")}
