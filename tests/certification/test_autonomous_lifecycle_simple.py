...
def run_certification_test():
    ...
    task_id = None
    hello_service_port = 5002  # Use unique port
    background_processes = []

    try:
        # Step 1: Create deployment task
        ...
        # Task specification
        task_data = {
            "project_name": "hello-service-cert",
            "description": "Certification test: Build minimal Flask web service",
            "requirements": {
                "framework": "Flask",
        ...
        workflow_stages = [
            ("planning", "AI Planner analyzing certification requirements", 1),
            ("specification", "Creating technical specifications", 1),
            ("code_generation", "Backend Worker generating Flask application", 2),
        ...
        for i, (status, description, duration) in enumerate(workflow_stages, 1):
            ...
            # Generate application files during code generation
...
'''
        ...
        # Step 3: Validate deployed service
