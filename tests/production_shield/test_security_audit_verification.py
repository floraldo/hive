...
from security_audit import PostDeploymentSecurityAuditor, SecurityAuditResult
...
class MaliciousDeploymentGenerator:
    ...
    def create_leaked_secrets_log(self, filename: str = "application.log"):
        ...
        with open(log_file, 'w') as f:
            ...
            f.write("2023-12-01T10:03:00Z [ERROR] Authentication failed with token: bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9\n")
            f.write("2023-12-01T10:04:00Z [DEBUG] Database connection string: postgresql://admin:password123@prod-db:5432/app\n")
            f.write("2023-12-01T10:05:00Z [INFO] AWS credentials loaded: aws_access_key_id=AKIAIOSFODNN7EXAMPLE\n")
            f.write("2023-12-01T10:06:00Z [DEBUG] Private key loaded: -----BEGIN RSA PRIVATE KEY-----\nMIIEpAIBAAKCAQEA1234567890abcdef...\n")
