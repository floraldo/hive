...
class ProductionMonitor:
    ...
    def analyze_results(self) -> Dict:
        ...
        healthy_response_times = [r.response_time_ms for r in self.results 
                                if r.is_healthy and r.response_time_ms is not None]
    ...
    def generate_monitoring_report(self, analysis: Dict) -> str:
        ...
        report_lines.extend([
            ...
            f"**Environment**: All monitored environments",
            "",
            "## 📊 Health Summary",
            "",
...
def main():
    ...
    parser.add_argument("--environment", choices=['all', 'production', 'staging', 'development'], 
                       default='all', help="Environment to monitor")
