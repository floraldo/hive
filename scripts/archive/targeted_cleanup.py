...
def should_skip_directory(path: Path) -> bool:
    ...
    skip_patterns = {".venv", ".venv-wsl", "__pycache__", ".pytest_cache", "node_modules", ".git", ".cache"}
...
def categorize_root_docs(docs: List[Path]) -> Dict[str, List[Path]]:
    ...
    categories = {"reports": [], "operations": [], "plans": [], "analysis": [], "delete": []}
...
def create_organized_structure():
    ...
    directories = ["docs/reports", "docs/operations", "docs/analysis", "docs/plans"]
...
def remove_obsolete_files(dry_run: bool = True):
    ...
    obsolete_patterns = ["temp_*", "*_temp", "*_old", "*_backup", "test_*_old*", "debug_*", "scratch_*"]
